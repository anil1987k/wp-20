    ...
    <div class="container">
        <div class="header__content">
            ...
            <?php if( $logo = get_theme_mod('logo') ) : ?>
                <a href="<?php echo esc_url( home_url('/') ); ?>" class="logo" title="<?php echo bloginfo('name'); ?>"><img src="<?php echo esc_url( $logo ); ?>" alt="<?php echo esc_attr(bloginfo('name')); ?>"></a>
            <?php else: ?>
            ...
            if( get_theme_mod( 'top_bar_shopping_cart', true ) ) : ?>
                <?php smarty_get_layout_file('/parts', '/mini-cart'); ?>
            <?php endif; ?>
